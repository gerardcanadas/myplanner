...
import gcanadas.com.myplanner.pushnotifications.MyPlanner_FirebaseInstanceIdService;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean isUserLoggedIn = mPrefs.getBoolean("loggedIn", false);
        if (isUserLoggedIn) {
            goToMainActivity(this.getApplicationContext());
        }
        ...
        mEmailView.setText("gerard.canadas@gmail.com");
