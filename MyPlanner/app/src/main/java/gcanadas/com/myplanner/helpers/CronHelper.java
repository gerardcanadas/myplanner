package gcanadas.com.myplanner.helpers;

/**
 * Created by gerard on 5/5/17.
 */

public class CronHelper {

    private static CronHelper instance;
    public static CronHelper getInstance() {
        if (instance == null)
            instance = new CronHelper();
        return instance;
    }

    protected CronHelper() {
        //isolated constructor for singleton instance
    }
